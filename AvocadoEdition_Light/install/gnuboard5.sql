...
CREATE TABLE IF NOT EXISTS `avo_css_config` (
  ...
  `cs_etc_11` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_12` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_13` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_14` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_15` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_16` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_17` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_18` varchar(255) NOT NULL DEFAULT '',
  `cs_etc_19` varchar(255) NOT NULL DEFAULT '',
